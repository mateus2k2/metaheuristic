...
def parse_args():
    ...
    constructive_parser = subparsers.add_parser('constructive', help='Run the constructive process.')
    ...
    MILP_parser = subparsers.add_parser('MILP', help='Run the MILP process.')
